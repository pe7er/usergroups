...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_usergroups&task=contacts.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="contactList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_usergroups&task=contact.edit&id='.(int) $item->id); ?>">
